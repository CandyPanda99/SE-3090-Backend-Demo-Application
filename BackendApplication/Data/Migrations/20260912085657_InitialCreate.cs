        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EstimatedHours = table.Column<decimal>(type: "numeric(6,2)", precision: 18, scale: 2, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Tasks_CompletedAt_Matches_Status", "(\"Status\" = 'Done' AND \"CompletedAtUtc\" IS NOT NULL) OR (\"Status\" <> 'Done' AND \"CompletedAtUtc\" IS NULL)");
